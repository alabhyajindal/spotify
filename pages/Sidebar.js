    ...
    <header className=' bg-black p-5'>
      ...
      <div className='mt-6'>
        <div className='flex gap-4 items-center'>
          ...
          <h2 className='text-slate-300 font-bold text-sm'>Home</h2>
        </div>
        <div className='flex gap-4 items-center mt-4'>
          <SearchIcon className='h-6 text-slate-300' />
          <h2 className='text-slate-300 font-bold text-sm'>Search</h2>
        </div>
        <div className='flex gap-4 items-center mt-4'>
          <CollectionIcon className='h-6 text-slate-300' />
          <h2 className='text-slate-300 font-bold text-sm'>Your Library</h2>
        </div>
      </div>
      ...
      <div className='mt-10'>
        <div className='flex gap-4 items-center'>
          ...
          <h2 className='text-slate-300 font-bold text-sm'>Create Playlist</h2>
        </div>
        <div className='flex gap-4 items-center mt-4'>
          <HeartIcon className='h-6 text-slate-300 bg-purple-600 p-1 rounded-sm' />
          <h2 className='text-slate-300 font-bold text-sm'>Liked Songs</h2>
        </div>
        <div className='flex gap-4 items-center mt-4'>
          <BookmarkIcon className='h-6 text-green-500 bg-green-900 p-1 rounded-sm' />
          <h2 className='text-slate-300 font-bold text-sm'>Your Episodes</h2>
        </div>
      </div>

      <div className='border-t border-slate-700 mt-4 mb-4'></div>
      <ul className='text-slate-300 text-sm font-medium flex flex-col gap-4'>
